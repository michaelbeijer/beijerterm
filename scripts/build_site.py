    ...
    <div class="page-container">
        ...
        <main>
            <section class="tag-conventions">
                ...
                <ul>
                    <li><strong>Lowercase</strong> for generic subjects: <code>legal</code>, <code>medical</code>, <code>automotive</code></li>
                    <li><strong>Capitalize</strong> proper nouns only: <code>Microsoft</code>, <code>EU</code>, <code>BBC</code>, <code>ISO 9001</code></li>
                    <li><strong>Singular form</strong> preferred: <code>diamond</code> not <code>diamonds</code></li>

...
title: aanlooptijd
slug: aanlooptijd
description: Translation and definition of aanlooptijd
type: term
source_lang: nl
target_lang: en
domain: general
source_url: "https://superlookup.wiki/wiki/aanlooptijd"
...
**See also**: inlooptijd, oplooptijd, aflooptijd
 ...
 **See e.g.**: ‘What does **breaking-in** (break-in)  or **running-in** (run-in) mean?
 ...
 However, ‘running-in period’ is in fact translated into Dutch as, ‘[**inloop**tijd](inlooptijd)’, not ‘**aanloop**tijd’. See e.g. Comprehensive Dictionary of Industry and Technology (Graham P. Oxtoby):
...
1. # English
- <del>running-in time/period</del>
...
1. # Examples
; aanlooptijd van regulateur [CIV.ENG.](HYDROL.,) 
: governor dead time
